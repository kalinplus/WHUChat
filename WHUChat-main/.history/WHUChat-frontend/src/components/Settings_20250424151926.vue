                        ...
                        <v-expansion-panel-text>
                          ...
                          <div class="model-parameters">
                            ...
                            >
                              <template v-slot:prepend>
                                <v-tooltip location="bottom">
                                  <template v-slot:activator="{ props }">
                                    <v-icon v-bind="props" class="mr-2">mdi-thermometer</v-icon>
                                  </template>
                                  <span>控制回复的随机性。较低的值使输出更确定，较高的值使输出更随机。</span>
                                </v-tooltip>
                              </template>
                              <template v-slot:append>
                                <v-text-field
                                  v-model.number="model.parameters.temperature"
                                  type="number"
                                  style="width: 70px"
                                  density="compact"
                                  hide-details
                            ...
                            <v-select
                              ...
                              label="回复类型"
                              :items="[
                                { title: '平衡 (默认)', value: 'balanced' },
                                { title: '精确', value: 'precise' },
                            ...
                            >
                              <template v-slot:prepend>
                                <v-tooltip location="bottom">
                                  <template v-slot:activator="{ props }">
                                    <v-icon v-bind="props" class="mr-2">mdi-format-list-text</v-icon>
                                  </template>
                                  <span>设置AI回复的风格倾向。</span>
                                </v-tooltip>
                              </template>
                            </v-select>
                          </div>
